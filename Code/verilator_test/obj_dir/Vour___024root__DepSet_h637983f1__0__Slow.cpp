...
VL_ATTR_COLD void Vour___024root___initial__TOP__0(Vour___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vour__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vour___024root___initial__TOP__0\n"); );
    // Body
...
VL_ATTR_COLD void Vour___024root___eval_initial(Vour___024root* vlSelf) {
    ...
    // Body
    Vour___024root___initial__TOP__0(vlSelf);
}
